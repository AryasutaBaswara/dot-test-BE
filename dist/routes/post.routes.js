...
postRoutes.post("/", authMiddleware.authenticateToken, postController.handleCreatePost);
// PATCH /api/posts/:id -> Edit postingan
// WAJIB punya token. Penjaga akan memeriksa tokennya dulu.
postRoutes.patch("/:id", authMiddleware.authenticateToken, postController.handleUpdatePost);
