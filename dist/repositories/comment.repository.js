...
exports.createComment = async (text, authorId, postId) => {
    const queryText = 'INSERT INTO "Comment"(text, "authorId", "postId") VALUES($1, $2, $3) RETURNING *';
...
exports.findCommentsByPostId = async (postId) => {
    const queryText = 'SELECT * FROM "Comment" WHERE "postId" = $1 ORDER BY "createdAt" ASC';
